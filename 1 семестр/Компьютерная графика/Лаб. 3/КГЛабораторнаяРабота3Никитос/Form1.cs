...
namespace Interpolation
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            new triangle(15, 25, 12, 20, 18, 20),
            new triangle(13, 20, 6, 20, 9, 15),
            new triangle(24, 20, 17, 20, 21, 15),
            new triangle(9, 15, 12, 10, 6, 10),
            new triangle(21, 15, 24, 10, 18, 10),
            new triangle(18, 10, 12, 10, 15, 5),

            new triangle(12, 20, 9, 15, 12, 10),
            new triangle(18, 20, 21, 15, 18, 10),
            new triangle(18, 20, 12, 20, 18, 10),
            new triangle(13, 20, 18, 10, 12, 10),
        };
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Bitmap bitmapForInitialImage = new Bitmap("2.bmp");
            pbInitialImage.Image = bitmapForInitialImage;

            Bitmap bmpScaledImage = bilinealInterpolation(bitmapForInitialImage, 2, 2);
